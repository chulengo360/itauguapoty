      ...
      "infoHotspots": [
        {
          ...
          "title": "Techo Verde",
          "text": "La casa no se nota desde el cielo porqu√© tiene un techo vivo de plantas."
        },
        {
        ...
        },
        {
          ...
          "title": "<span style=\"font-weight: bold; color: rgb(95, 99, 104); font-family: arial, sans-serif; font-size: 14px; background-color: rgb(255, 255, 255);\">Cerro K√µi</span>",
          "text": "Fue declarado como patrimonio natural en 1993 debido a la forma de sus piedras (octogonales) que solamente existen tres en el mundo; en Sud√°frica Canad√°&nbsp;y en&nbsp;<a href=\"https://es.wikipedia.org/wiki/Paraguay\" style=\"color: rgb(255, 233, 0); overflow-wrap: break-word; font-weight: 400;\">Paraguay</a>&nbsp;(este mismo)."
        }
      ]
    },
    {
      ...
      "infoHotspots": [
        {
          ...
          "text": "El taller ha sido construido con BTC (bloques de tierra comprimida). Se trata de bloques constructivos fabricados a base de una mezcla de tierra, arena y arcilla, pudiendo contener tambiÈn cal aÈrea o hidr·ulica como estabilizante. Tras preparar la mezcla adecuada se moldea y comprime en una prensa mec·nica. Los muros de tierra presentan una ventaja y es que regulan de manera natural la humedad y la temperatura de la vivienda."
        },
        {
